 ...
 */
class ProjetoTeste_ extends \PHPUnit_Framework_TestCase{
...
//    } 
     ...
     */
    public function testeDefinirNome() {
        ...
        $this->assertEquals($nome, $this->projeto->obterNome());
...
//        
//        $this->projeto->definirDocumentacaoDeTeste($this->documentacaoDeTeste);
//        
//        $this->assertInstanceOf(
...
//        $docTeste = $this->projeto->obterDocumentacaoDeTeste();
//        
//        $this->assertEquals(
//                $this->projeto->definirDocumentacaoDeTeste($this->documentacaoDeTeste), 
//                $docTeste
